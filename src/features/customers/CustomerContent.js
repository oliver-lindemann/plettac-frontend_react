...
const CustomerContent = ({ customer, onSaveButtonClicked }) => {
  ...
  const [customerNr, setCustomerNr] = useState(customer?.customerNr || "");
  ...
  const onCustomerNrChanged = (e) => setCustomerNr(e.target.value);
  ...
  return (
    <DefaultSmallContainer>
      ...
      >
        <Form.Group as={Col} className="mb-3">
          <FloatingLabel label="Kundenname">
            ...
            <Form.Control.Feedback type="invalid">
              Bitte gib einen Kundennamen ein.
        ...
        <Form.Group as={Col} className="mb-3">
          <FloatingLabel label="Kundennummer (Plettac)">
            <Form.Control
              type="text"
              placeholder="Kundennummer (Plettac"
              value={customerNr}
              onChange={onCustomerNrChanged}
            />
          </FloatingLabel>
        </Form.Group>
        ...
        <FloatingButton
          ...
          disabled={isSaving}
          icon={
            isSaving ? <Spinner /> : <SaveIcon width="1.5em" height="1.5em" />
          }
        />
      </Form>
    </DefaultSmallContainer>
