...
const EditDeliveryNote = lazy(() => import('./features/deliveryNotes/EditDeliveryNote')); // Lazy
...
const AllRoutes = () => {
  ...
  return (
    <Paper elevation={0} sx={{ pb: (!!user && !isDesktop ? '50px' : 0), pl: (isDesktop && !!user ? '240px' : 0) }} style={{ height: `calc(100% - ${TOP_NAV_HEIGHT}px)` }}>
